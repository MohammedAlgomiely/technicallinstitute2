<?php
require 'config.php';
$stmt = $conn->prepare("select news_title , news_content from news");
$stmt->execute();
    ...
    <header class="bg-white dark:bg-gray-800 shadow-md transition-colors duration-300">
            ...
            <div class="flex justify-between h-16 items-center">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <image id="logo2" src="images/institute_ins2.jpg" class="h-auto w-16 ml-2.5 rounded-full"></image>
                    </div>
                    <div class="flex-shrink-[1]">
                        <h2 class="text-ll font-bold text-primary">المعهد التقني التجاري - الحصب</h2>
                    </div>
                </div>
                <nav class="hidden md:flex space-x-4 space-x-reverse items-center">
                    <a href="#home" class="px-3 py-2 rounded-md text-center text-sm font-bold text-gray-700 dark:text-gray-300 hover:text-primary transition-colors duration-300 bg-transparent hover:bg-primary hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary">الرئيسية</a>
                    ...
                    <a href="login_page.php" class="px-3 py-2 rounded-md text-center  text-sm font-bold text-gray-700 dark:text-gray-300 hover:text-primary transition-colors duration-300 bg-transparent hover:bg-primary hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary">تنسيق</a>
                    ...
                    <a href="#aboutIns" class="px-3 py-2 rounded-md text-center  text-sm font-bold text-gray-700 dark:text-gray-300 hover:text-primary transition-colors duration-300 bg-transparent hover:bg-primary hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary">عن المعهد</a>
                </nav>
        ...
        <div id="mobile-menu" class="md:hidden hidden transition-all duration-300 ease-in-out">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                ...
                <a href="login_page.php" class="block px-3 py-2 rounded-md text-base font-bold text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 hover:bg-primary hover:text-primary dark:hover:text-primary transition-colors duration-300">تنسيق</a>
                ...
                <a href="#aboutIns" class="px-3 py-2 rounded-md text-sm font-bold text-gray-700 dark:text-gray-300 hover:text-primary transition-colors duration-300 bg-transparent hover:bg-primary hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary">عن المعهد</a>
            </div>
        </div>
    </header>

    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        <!-- Institute Background Section -->
        <section id="home" class="py-6 md:py-6 slide-in h-400">
            <img src="images/back1.jpg" alt="jpg" style="height: 460px; width: 100%;">
        </section>
        <!-- Hero Section -->
        <section id="home" class="py-12 md:py-20 slide-in">
            <div class="flex flex-col md:flex-row gap-10 items-center">
                <div class="md:w-1/2 space-y-6">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <a href="login_page.php" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-bold rounded-md shadow-sm text-white bg-primary hover:bg-secondary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-colors duration-300">
                            قم بالتنسيق الآن
                        </a>
                        <a href="AvailableDepts.php" class="inline-flex items-center px-6 py-3 border border-primary text-base font-bold rounded-md text-primary bg-transparent hover:bg-primary hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-colors duration-300">
                            استكشف التخصصات
                        </a>
                    </div>
                </div>
                    ...
                    <div class="bg-white dark:bg-gray-700 p-6 rounded-lg border-t-4 border-primary shadow-inner">
                        ...
                        <?php 
                            ...
                            <li class='flex gap-3'>
                                ...
                                <div>
                                    <p class='font-bold text-gray-800 dark:text-gray-200'>";?><?php echo $news_title?><?php echo "</p>
                                    <p class='text-sm text-gray-600 dark:text-gray-400'>";?><?php echo $news_content?><?php echo "</p>
                                </div>
                            </li>";}?>
                        <?php }?>
                        </ul>
        ...
        <section id="aboutIns" class="py-12 border-t border-gray-200 dark:border-gray-700 fade-in">
            <div class="text-center mb-10">
                <h2 class="text-3xl font-bold text-gray-900 dark:text-white">عن المعهد</h2>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-6">
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                    ...
                    <div class="p-6">
                        ...
                        <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">الرؤية</h3>
                        <p class="text-gray-600 dark:text-gray-400 mb-4">أن يكون المعهد التقني التجاري - الحصب الرائج في تقديم برامج تعليمية وتدريبية متميزة وتطوير المهارات العلمية والتقنية لتلبية احتياجات سوق العمل المحلي والأقليمي</p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                    ...
                    <div class="p-6">
                        ...
                        <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">الرسالة</h3>
                        <p class="text-gray-600 dark:text-gray-400 mb-4">
                            يسعى المعهد التقني التجاري - الحصب الى إعداد كوادر مؤهلة ومتخصصة في المجالات التقنية والتجارية من خلال برامج أكاديمية وتدريبية عالية الجودة ، وتعزيز البحث العلمي وخدمة المجتمع ، بما يسهم في تحقيق التنمية الإقتادية والإجتماعية المستدامة للمحافظة</p>
                        <!--<div class="flex flex-wrap gap-2 mb-4">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                    ...
                    <div class="p-6">
                        ...
                        <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">القيم</h3>
                        <p class="text-gray-600 dark:text-gray-400 mb-4">
                            التميز ، الموضوعية ، الجودة ، الشفافية والمرونة ، العدالة والنزاهة ، الكفاءة والفعالية ، القيادة والعمل بروح الفريق الواحد ، المسؤولية والشراكة المجتمعية</p>
                        <!--<div class="flex flex-wrap gap-2 mb-4">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                    <div class="bg-primary h-2 w-full"></div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">كلمة العميد</h3>
                        <p class="text-gray-600 dark:text-gray-400 mb-4">بسم الله الرحمن الرحيم<br>

                            الاخوه والاخوات /أعضاء الهيئة الادرايه والتدريبية .
                            اعزائي الطلبة.
                            زوار موقعنا الكرام، أهلاً وسهلاً بكم في موقع المعهد التقني التجاري - الحصب.تعز
                            يسرنا اليوم أن نطلق هذا الموقع الإلكتروني ليكون نافذتكم إلى المعهد، حيث تجدون فيه كل ما تحتاجونه من معلومات عن برامجنا الأكاديمية، أقسامنا العلمية، والأنشطة التي نقدمها لخدمة طلابنا ومجتمعنا.
                            لقد حرصنا على أن يكون هذا الموقع منصة تفاعلية تسهل التواصل بين الطلبة، الهيئة الاداريه والتدريبيه  بالمعهد ، كما أنه سيكون مصدرًا موثوقًا لكل المستجدات والإعلانات الأكاديمية، إضافةً إلى كونه مساحة لتعزيز الابتكار والتطوير المستمر.
                            . إن هذا الموقع ليس مجرد منصة إلكترونية، بل هو نافذة مشرقة تعكس رؤيتنا الطموحة ورسالتنا الهادفة في إعداد جيل مؤهل علميًا وعمليًا، مسلحٍ بالمعرفة والمهارات التي تؤهله لخوض غمار سوق العمل بثقة واقتدار.
                            لقد حرصنا على أن يكون هذا الموقع وسيلة فعالة لتعزيز التفاعل بين الطلبه وأعضاء الهيئة الاداريه والتدريبية بالمعهد، وتقديم الخدمات الأكاديمية والإدارية بكل سهولة ويسر، إلى جانب كونه مصدرًا غنيًا بالمعلومات حول تخصصاتنا، أنشطتنا، ومستجدات العملية التعليمية.
                            إننا في المعهد التقني التجاري - الحصب نؤمن بأن التعليم التقني هو ركيزة أساسية في نهضة المجتمعات، ونحن ملتزمون بتقديم تعليم عالي الجودة يُمكّن طلابنا من اكتساب المهارات العملية والمعرفة العلمية التي تؤهلهم لمواكبة متطلبات سوق العمل والمساهمة في التنمية المستدامة.
                            ندعوكم إلى تصفح موقعنا، والتفاعل معنا، والاستفادة من الخدمات التي نوفرها لكم، متمنين لجميع طلابنا التوفيق والنجاح في مسيرتهم العلمية والمهنية.
                            معًا، نصنع المستقبل... وبالعلم نرتقي
                            </p>
                        <!--<div class="flex flex-wrap gap-2 mb-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 text-center">
                    ...
                    <p class="text-gray-600 dark:text-gray-400">
                        المدينة التقنية، طريق الجامعات<br>
                        ص.ب. 12345<br>
                        المدينة، البلد
                    </p>
                </div>
