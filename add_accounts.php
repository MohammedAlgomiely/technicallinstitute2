        ...
        <form id="loginForm" action="" method="post">
            ...
            <div class="form-group">
                ...
                <div class="input-icon">
                 ...
                 <label class="rolelabel">الصلاحية</label>
                 <div class="role">
                    <input name="userRole" class="roleInput1" type="radio" value="طالب"><b>طالب</b>
                    <input name="userRole" class="roleInput2" type="radio" value="طالب"><b>مدير</b>
                 </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmts->bind_param("ssss", $user_name, $hashed_password, $user_email, $user_role);
