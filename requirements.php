...
<body class="bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 transition-colors duration-300">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                ...
                <nav class="hidden md:flex space-x-4 space-x-reverse">
                    ...
                    <a href="#requirements" class="px-3 py-2 rounded-md text-sm font-bold text-gray-700 dark:text-gray-300 hover:text-primary transition-colors duration-300 bg-transparent hover:bg-primary hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary">شروط التسجيل والقبول</a>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        ...
        <section id="requirements" class="py-12 border-t border-gray-200 dark:border-gray-700 fade-in">
            <div class="text-center mb-10">
                <h2 class="text-3xl font-bold text-gray-900 dark:text-white">شروط التسجيل والقبول</h2>
            ...
            <div class="flex flex-col md:flex-row gap-8">
                <div class="md:w-1/2 bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
                    ...
                    <ul class="space-y-3 text-gray-600 dark:text-gray-400">
                        <li class="flex items-start">
                            ...
                            <div class="mr-3">أن يكون لائقاً صحياً للمهنة الراغب الإلتخاق بها.</div>
                        </li>
                        <li class="flex items-start">
                            <div class="flex-shrink-0 text-primary mt-1"><i class="fas fa-check-circle"></i></div>
                            <div class="mr-3">أن يكون متفرغاً كلياً للدراسة.</div>
                        </li>
                        <li class="flex items-start">
                            <div class="flex-shrink-0 text-primary mt-1"><i class="fas fa-check-circle"></i></div>
                            <div class="mr-3">أن لا يكون قد صدر بحقه قرار فصل من أي جهة تعليمية ما لم يكن قد رد له اعتباره.</div>
                        </li>
                        <!--<li class="flex items-start">
                            <div class="flex-shrink-0 text-primary mt-1"><i class="fas fa-check-circle"></i></div>
                            <div class="mr-3">أن يكون حاصلاً على الشهادة الثانوية العامة(القسم العلمي) أو شهادة الثانوية المهنية ذات نظام الثلاث سنوات.</div>
                        </li>
                        <li class="flex items-start">
                            <div class="flex-shrink-0 text-primary mt-1"><i class="fas fa-check-circle"></i></div>
                            <div class="mr-3">أن لا يكون قد مضى على حصوله على شهادة إتمام المرحلة الثانوية العامة أكثر من ثلاثة أعوام دراسية بعد سنة التخرج إلا إذا ثبت ما يفيد استمراره بالدراسة.</div>
                        </li>-->
                ...
                <div class="md:w-1/2 bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-4 flex items-center">
                        <span class="w-8 h-8 rounded-full bg-primary flex items-center justify-center text-white text-sm mr-2">3</span>
                        الشروط الخاصة للتسجيل
                    </h3>
                    <ul class="space-y-3 text-gray-600 dark:text-gray-400">
                        <li class="flex items-start">
                            <div class="flex-shrink-0 text-primary mt-1"><i class="fas fa-check-circle"></i></div>
                            <div class="mr-3">أن يكون المتقدم حاصلاً على :-<br>
                                 <div class="mr-3">- الشهادةالثانوية العامة (القسم العلمي) او شهادة الثانوية المهنية للتخصصات (الصناعية - الزراعية - البيطرية - الصحية - البحرية).</div>
                                 <div class="mr-3">- الشهادة الثانوية العامة (القسم العلمي) - (الأدبي) او الثانوية المهنية للتخصصات (التجارية - الفندقية -  السياحية).</div>
                            </div>
                        </li>
                        <li class="flex items-start">
                            <div class="flex-shrink-0 text-primary mt-1"><i class="fas fa-check-circle"></i></div>
                            <div class="mr-3">أن لا يكون قد مضى على حصوله شهادة اتمام المرحلة الثانوية أكثر من ثلاثة أعوام دراسية بعد سنة التخرج إلا إذا أحضر ما يفيد استمراره في الدراسة.</div>
                        </li>
                        <li class="flex items-start">
                            <div class="flex-shrink-0 text-primary mt-1"><i class="fas fa-check-circle"></i></div>
                            <div class="mr-3">المتقدم من مخرجات الثانوية المهنية ويمارس عملاً (حكومي - أهلي - خاص) في مجال التخصص يمكنه التسجيل وفقاً للشروط التالية :-<br>
                                 <div class="mr-3">- استمراره في العمل لمدة عام او أكثر.</div>
                                 <div class="mr-3">- موافقة الجهة او صاحب العمل على التحاقه واستمراره في التعليم والتدريب.</div>
                                 <div class="mr-3">- أن يجتاز التدريبات العملية في التخصص بنجاح.</div>
                            </div>
                        </li>
                        <li class="flex items-start">
                            <div class="flex-shrink-0 text-primary mt-1"><i class="fas fa-check-circle"></i></div>
                            <div class="mr-3">يقوم الطالب بتعبئة نموذج الإلتحاق.</div>
                        </li>
                        <!--<li class="flex items-start">
                            <div class="flex-shrink-0 text-primary mt-1"><i class="fas fa-check-circle"></i></div>
                            <div class="mr-3">يخضع الطلبة الحاصلين على شهادة الثانوية العامة إلى معايير المفاضلة التالية: المقابلة الشخصية ، اختبارات الميول المهنية ، اختبارات القدرات والإستعدادات ، اختبار التحصيل العلمي.</div>
                        </li>-->
                    </ul>
                </div>
                <div class="md:w-1/2 bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-4 flex items-center">
                        ...
                        الوثائق المطلوبة بعد القبول
                    </h3>
                    <ul class="space-y-3 text-gray-600 dark:text-gray-400">
                        <li class="flex items-start">
                            <div class="flex-shrink-0 text-primary mt-1"><i class="fas fa-file-alt"></i></div>
                            <div class="mr-3">النسخة الأصل من استمارة القبول</div>
                        </li>
                        <li class="flex items-start">
                            <div class="flex-shrink-0 text-primary mt-1"><i class="fas fa-file-alt"></i></div>
                            <div class="mr-3">النسخة الأصل من استمارة الثانوية العامة (علمي) او الثانوية المهنية.</div>
                        </li>
                        <li class="flex items-start">
                            <div class="flex-shrink-0 text-primary mt-1"><i class="fas fa-file-alt"></i></div>
                            <div class="mr-3">شهادة طبية بخلوه من الأمراض النفسية والعقلية والبدنية.</div>
                        </li>
                        <li class="flex items-start">
                            <div class="flex-shrink-0 text-primary mt-1"><i class="fas fa-file-alt"></i></div>
                            <div class="mr-3">ثمان صور ملونة حديثة (خلفية بيضاء مطفي) مقاس 4 × 6 سم.</div>
                        </li>
                        <!--<li class="flex items-start">
                            <div class="flex-shrink-0 text-primary mt-1"><i class="fas fa-file-alt"></i></div>
                            <div class="mr-3">شهادة طبية تفيد بخلوه من الأمراض السارية.</div>
                        </li>
                        <li class="flex items-start">
                            <div class="flex-shrink-0 text-primary mt-1"><i class="fas fa-file-alt"></i></div>
                            <div class="mr-3">النسخة الأصلية من استمارة الشهادة الثانوية.</div>
                        </li>-->
                    </ul>
                </div>
            </div>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 gap-8">
                    <div>
                        ...
                        <ul class="space-y-2">
                            ...
                            <li><a href="#requirements" class="text-gray-400 hover:text-white transition-colors duration-300">شروط التسجيل والقبول</a></li>
